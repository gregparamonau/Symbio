...
public class GameEditor {
	...
	public static void draw_view(Graphics g) {
		for (int x = 0; x<rooms_display.length; x++) {
			...
			rooms_display[x].draw(g, Start.pane, LevelEditor.pos.x, LevelEditor.pos.y, "edit", true);
	...
	public static void display_room_options() {
		...
		Start.o_pane = new OptionPane(LevelEditor.click, new String[] {"new room", "edit room", "delete room", "cancel"}, new Runnable[] {
				...
				() -> {
					...
					System.out.println("EDITING ROOM2: " + last_selected_room);
					...
					System.out.println("EDITING ROOM3");
					System.out.println("THREAD: " + Thread.currentThread().getContextClassLoader());
					System.out.println("ROOME: " + Thread.currentThread().getContextClassLoader());
					System.out.println("CODE SOURCE: " + RoomEditor.class.getProtectionDomain().getCodeSource().getLocation());
					
					RoomEditor.room_editing = last_selected_room;
					
					System.out.println("EDITING ROOM4");
					System.out.println("ROOM SELECT LAST: " + last_selected_room);
	...
	public static void add_to_display() {
		...
		temp[rooms_display.length] = new Rectangle(LevelEditor.click.x, LevelEditor.click.y, 16, 16);
