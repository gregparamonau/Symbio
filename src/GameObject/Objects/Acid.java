...
public class Acid extends GameObject{
	...
	void start_bubbles() {
		...
		for (int x = 0; x<this.bubbles.length; x++) {
			...
			this.bubble_anims[x] = new Animation(bubble, this.bubbles[x], false, false);
			this.bubble_anims[x].start();
		}
	}
	void update_bubbles() {
	...
	public String toString() {
		return "GameObject.Objects.Acid " + this.pos.x + " " + this.pos.y + " " + this.width + " " + this.height + " " + this.object_handle + " " + sprite_name_default + " ";
	}
