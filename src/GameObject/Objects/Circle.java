...
public class Circle extends GameObject{
	...
	public Vector2 displace_entity(Rectangle in, int direction) {
		if (!Rectangle.intersect_circle(in, this.pos, this.radius)) return Vector2.zero;
	...
	public void draw_blank_object(Graphics g, Rectangle bounds) {
		...
		g.fillOval((int)(temp_pos.x - this.width / 2), (int)(temp_pos.y - this.height / 2), (int)this.width, (int)this.height);
	}
