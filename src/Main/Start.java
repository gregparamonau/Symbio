...
public class Start {
	...
	public static void init() {
		...
		imgs[0] = new BufferedImage((int)(pane.getWidth() / Camera.pixel_size), (int)(pane.getHeight() / Camera.pixel_size + 2), 1);
		imgs[1] = new BufferedImage((int)(pane.getWidth() / Camera.pixel_size), (int)(pane.getHeight() / Camera.pixel_size + 2), 1);
		
		gs[0] = (Graphics2D) imgs[0].getGraphics();
		gs[1] = (Graphics2D) imgs[1].getGraphics();
		
		Camera.res_width = (int)(pane.getWidth() / Camera.pixel_size);
		Camera.res_height = (int)(pane.getHeight() / Camera.pixel_size);
	}
