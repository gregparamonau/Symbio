...
public class Rectangle {
	...
	//rendering
	public void draw(Graphics g, JPanel in, double xin, double yin, String location, boolean draw_nodes) {		
		this.start_nodes();
		...
		if (location.equals("edit") && draw_nodes) {
			this.draw_border(g, in, xin, yin, location);
			this.draw_nodes(g, in, xin, yin, location);
		}
	...
	public Vector2[] to_polygon() {
		return new Vector2[] {new Vector2(this.pos.x - this.width / 2, this.pos.y - this.height / 2),
	...
	public Vector2 outplace_vec(Vector2 in) {
		if (!Rectangle.intersect(this, new Rectangle(in.x, in.y, 0, 0))) return in;
		double outx = this.pos.x + this.width / 2 - in.x > in.x - this.pos.x + this.width / 2 ? this.pos.x - this.width / 2 : this.pos.x + this.width / 2;
		double outy = this.pos.y + this.height / 2 - in.y > in.y - this.pos.y + this.height / 2 ? this.pos.y - this.height / 2 : this.pos.y + this.height / 2;
	...
	public Polygon get_pol() {
		Polygon out = new Polygon(new Vector2[] {
				new Vector2(this.pos.x - this.width / 2, this.pos.y - this.height / 2),
				new Vector2(this.pos.x - this.width / 2, this.pos.y + this.height / 2),
				new Vector2(this.pos.x + this.width / 2, this.pos.y + this.height / 2),
				new Vector2(this.pos.x + this.width / 2, this.pos.y - this.height / 2),
