...
public class PlayerMovement {
	...
	//wall slide
	public static final double wall_slide_speed = 0.5, wall_jump_force = 8.5, vert_wall_jump_mult = 0.67;
	...
	//valuable
	/*PLAYER: (-146.80077435762357, 460.30977927948015)
rect before disp: (-141.14208369429824, 456.4818414778189)
displaced rect: (-141.43090073079983, 457.5408372783247) LINE: (-55.6367095600847, 478.5777741141742) (-143.63670956008525, 454.5777741141742)
rect before disp: (-141.43090073079983, 457.5408372783247)
displaced rect: (-141.719341724597, 458.598454255581) LINE: (-55.6367095600847, 478.5777741141742) (-143.63670956008525, 454.5777741141742)
rect before disp: (-141.719341724597, 458.598454255581)
displaced rect: (-142.0069177457563, 459.65289966649846) LINE: (-55.6367095600847, 478.5777741141742) (-143.63670956008525, 454.5777741141742)
rect before disp: (-142.0069177457563, 459.65289966649846)
displaced rect: (-142.29172688957004, 460.69719986048216) LINE: (-55.6367095600847, 478.5777741141742) (-143.63670956008525, 454.5777741141742)
rect before disp: (-142.29172688957004, 460.69719986048216)
displaced rect: (-142.55720079832, 461.6706041925653) LINE: (-55.6367095600847, 478.5777741141742) (-143.63670956008525, 454.5777741141742)
*/
	
	//could start working on normal maps for sprites
	...
	public void update_physics() {
		if (this.player.combat.hit && this.player.combat.pogo) this.gravity = Math.min(this.gravity, PlayerCombat.pogo_gravity);
